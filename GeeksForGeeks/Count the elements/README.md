...
<p><span style="font-size: 18px;"><strong>Expected Time Complexity:</strong> O(n+q).<br><strong>Expected Auxiliary Space:</strong> O(maximum of <strong>a</strong> and <strong>b</strong>).</span></p>
